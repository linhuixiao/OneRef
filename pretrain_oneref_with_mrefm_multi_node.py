...
def get_args_parser():
    ...
    parser.add_argument('--enable_mim_vts', action='store_true', help="If true, use mim visual target relation score")
    parser.add_argument('--enable_mlm_sts', action='store_true', help="If true, use mlm semantic target relation score")
    parser.add_argument('--enable_mrefm', action='store_true', help="If true, use milm loss")
...
def set_args(args):
    ...
    args.aug_crop = True
    args.aug_scale = True
    args.aug_translate = True
    args.imsize = 384
    args.max_query_len = 64
    args.sup_type = "full"
    args.model = "beit3_base_patch16_384"
    args.task = "grounding"
    args.enable_mrefm = True
    args.enable_dynamic_mim = True
    args.dynamic_mask_ratio = 0.75
    # args.use_regress_box = True
    # args.use_box_mask_constraints = True
    args.enable_seg_mask = True
    args.sentencepiece_model = "/userhome/lhxiao/checkpoint/beit3/beit3.spm"
    args.tokenizer_weight = "/userhome/lhxiao/checkpoint/beit3/vqkd_encoder_base_decoder_3x768x12_clip-d5036aa7.pth"
    # args.finetune = "/userhome/lhxiao/outputs/OneRef/v026_1/mixup/checkpoint.pth"
    args.dataset = "mixup"
    args.data_root = "/userhome/datasets/downstream/grounding_data"
    args.split_root = "/userhome/lhxiao/annotation/refer_LAVT/ref_data_shuffled_with_mixup/mixup_with_rec_referit/"
    args.output_dir = "/userhome/lhxiao/outputs/BeitVG/v039_1/mixup"
