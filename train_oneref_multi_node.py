...
def set_args(args):
    ...
    args.finetune = "/userhome/lhxiao/outputs/OneRef/v024_3/gref_umd/best_checkpoint.pth"
    args.dataset = "gref_umd"
    args.data_root = "/userhome/datasets/downstream/grounding_data"
    args.split_root = "/userhome/lhxiao/annotation/refer_LAVT/ref_data_shuffled_with_mixup"
    args.output_dir = "/userhome/lhxiao/outputs/OneRef/v024_jiqun/gref_umd"
