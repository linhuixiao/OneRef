...
class NormalizeAndPad(object):
    ...
    def __call__(self, input_dict):
        ...
        # distributed on the top and bottom, as well as the left and right. The meaning of translation enhancement is
        # that there should be less padding on the top and left.
        ...
        if 'box' in input_dict.keys():
            box = input_dict['box']  # x1y1x2y2 format
